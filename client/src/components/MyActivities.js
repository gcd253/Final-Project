  ...
  return (
    <div>My Activities: messages and posts
      <div className="p-6 flex flex-row" >
        <div onClick={userPosts} className="duration-500 mx-8 bg-gray-400 text-gray-100 p-4 pl-6 pr-6 rounded-full hover:bg-red-500 hover:text-white hover:scale-[1.03]" >
